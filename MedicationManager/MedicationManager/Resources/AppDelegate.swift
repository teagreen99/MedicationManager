...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func setNotificationCategories() {
        ...
        let medicationActionCategory = UNNotificationCategory(identifier: StringConstants.notificationCategoryIdentifier, actions: [markTakenAction, ignoreAction], intentIdentifiers: [], hiddenPreviewsBodyPlaceholder: "", options: .customDismissAction)
        
        UNUserNotificationCenter.current().setNotificationCategories([medicationActionCategory])
    }
